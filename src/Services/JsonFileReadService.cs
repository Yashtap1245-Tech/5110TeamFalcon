...
namespace ContosoCrafts.WebSite.Services
{
   public class JsonFileReadService
    {
        public JsonFileReadService(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IEnumerable<ReadModel> GetAllData()
        {
            using(var jsonFileReader = File.OpenText(JsonFileName))
            {
                return JsonSerializer.Deserialize<ReadModel[]>(jsonFileReader.ReadToEnd(),
        ...
        public ReadModel UpdateData(ReadModel data)
        {
            var products = GetAllData();
        ...
        /// </summary>
        private void SaveData(IEnumerable<ReadModel> products)
        {

            using (var outputStream = File.Create(JsonFileName))
            {
                JsonSerializer.Serialize<IEnumerable<ReadModel>>(
        ...
        /// </summary>
        /// <returns></returns>
        public ReadModel CreateData()
        {
            var data = new ReadModel()
            {
        ...
        /// </summary>
        /// <returns></returns>
        public ReadModel DeleteData(string id)
        {
